 ...
 * 
 * Code of GCanvas taken from https://github.com/NatashaTheRobot
 */
import acm.graphics.*;
...
public void reset() {
    ...
    add(scaffold);
    double beamRightX = scaffoldX + BEAM_LENGTH;
    GLine beam = new GLine(scaffoldX, scaffoldTopY, beamRightX, scaffoldTopY);
    add(beam);
 ...
 */
public void noteIncorrectGuess(String error, Integer counter_incorrect_guess) {
    ...
    if(counter_incorrect_guess == 1) {
        drawHead();
    }
    if(counter_incorrect_guess == 2) {
        drawBody();
    }
    if(counter_incorrect_guess == 3) {
        drawLeftArm();
    }
    if(counter_incorrect_guess == 4) {
        drawRightArm();
    }
    if(counter_incorrect_guess == 5) {
        drawLeftLeg();
    }
    if(counter_incorrect_guess == 6) {
        drawRightLeg();
    }
    if(counter_incorrect_guess == 7) {
        drawLeftFoot();
    }
    if(counter_incorrect_guess == 8) {
        drawRightFoot();
    }
}
